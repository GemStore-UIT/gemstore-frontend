...
class _PhieuDichVuUpdateDialogState extends State<PhieuDichVuUpdateDialog> {
  ...
  void _addDichVu() {
    setState(() {
      ...
      _tongTienTraTruocControllers.add(TextEditingController());
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: 60,
                      child: TextFormField(
                        initialValue: dichVu.soLuong.toString(),
                        keyboardType: TextInputType.number,
                        decoration: const InputDecoration(labelText: 'SL'),
                        onChanged: (value) {
                          setState(() {
                            dichVu.soLuong = int.tryParse(value) ?? 1;
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        initialValue: dichVu.tongTienTraTruoc.toString(),
                        onChanged: (value) {
                          setState(() {
                            dichVu.tongTienTraTruoc = int.tryParse(value) ?? 0;
                            dichVu.updateTongTien();
                          });
                        },
                      ),
